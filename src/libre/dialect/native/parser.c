...
#line 211 "src/libre/dialect/native/parser.c"
...
static void p_215(flags, lex_state, act_state, err, t_char *, t_pos *, t_ast__expr *);
static void p_218(flags, lex_state, act_state, err, t_pos *, t_unsigned *, t_ast__count *);
...
#line 256 "src/libre/dialect/native/parser.c"
			}
...
#line 433 "src/libre/dialect/native/parser.c"
		}
...
#line 491 "src/libre/dialect/native/parser.c"
					}
					/* END OF EXTRACT: CHAR */
					ADVANCE_LEXER;
				}
...
#line 525 "src/libre/dialect/native/parser.c"
					}
					/* END OF EXTRACT: ESC */
					ADVANCE_LEXER;
				}
...
#line 578 "src/libre/dialect/native/parser.c"
					}
					/* END OF EXTRACT: HEX */
					ADVANCE_LEXER;
				}
...
#line 631 "src/libre/dialect/native/parser.c"
					}
					/* END OF EXTRACT: OCT */
					ADVANCE_LEXER;
				}
...
#line 653 "src/libre/dialect/native/parser.c"
		}
...
#line 689 "src/libre/dialect/native/parser.c"
			}
			/* END OF EXTRACT: CHAR */
			ADVANCE_LEXER;
...
#line 788 "src/libre/dialect/native/parser.c"
			}
			/* END OF EXTRACT: HEX */
			ADVANCE_LEXER;
...
#line 847 "src/libre/dialect/native/parser.c"
			}
			/* END OF EXTRACT: OCT */
			ADVANCE_LEXER;
...
#line 922 "src/libre/dialect/native/parser.c"
		}
...
#line 1057 "src/libre/dialect/native/parser.c"
		}
...
#line 1090 "src/libre/dialect/native/parser.c"
			}
			/* END OF ACTION: ast-make-alt */
...
#line 1113 "src/libre/dialect/native/parser.c"
			}
...
#line 1133 "src/libre/dialect/native/parser.c"
		}
...
#line 1147 "src/libre/dialect/native/parser.c"
		}
		/* END OF ACTION: ast-make-empty */
	}
	goto ZL0;
...
static void
p_215(flags flags, lex_state lex_state, act_state act_state, err err, t_char *ZI212, t_pos *ZI213, t_ast__expr *ZOnode)
{
	t_ast__expr ZInode;
...
#line 1256 "src/libre/dialect/native/parser.c"
			}
...
#line 1276 "src/libre/dialect/native/parser.c"
						}
...
#line 1408 "src/libre/dialect/native/parser.c"
						}
						/* END OF EXTRACT: HEX */
						ADVANCE_LEXER;
					}
...
#line 1478 "src/libre/dialect/native/parser.c"
						}
						/* END OF EXTRACT: RANGE */
						ADVANCE_LEXER;
					}
...
#line 1568 "src/libre/dialect/native/parser.c"
			}
...
static void
p_218(flags flags, lex_state lex_state, act_state act_state, err err, t_pos *ZI216, t_unsigned *ZIm, t_ast__count *ZOc)
{
	t_ast__count ZIc;
...
#line 1674 "src/libre/dialect/native/parser.c"
				}
...
#line 1841 "src/libre/dialect/native/parser.c"
			}
...
#line 1869 "src/libre/dialect/native/parser.c"
				}
				/* END OF EXTRACT: COUNT */
				break;
			default:
			...
			ADVANCE_LEXER;
			p_218 (flags, lex_state, act_state, err, &ZI216, &ZIm, &ZIc);
			if ((CURRENT_TERMINAL) == (ERROR_TERMINAL)) {
				RESTORE_LEXER;
				goto ZL1;
			}
...
#line 1893 "src/libre/dialect/native/parser.c"
			}
...
#line 1934 "src/libre/dialect/native/parser.c"
			}
...
#line 2007 "src/libre/dialect/native/parser.c"
			}
...
#line 2026 "src/libre/dialect/native/parser.c"
			}
...
#line 2055 "src/libre/dialect/native/parser.c"
			}
...
#line 2135 "src/libre/dialect/native/parser.c"
		}
		/* END OF ACTION: ast-make-empty */
	}
	goto ZL0;
...
#line 2194 "src/libre/dialect/native/parser.c"
		}
		/* END OF ACTION: ast-make-named */
	}
	goto ZL0;
...
#line 2226 "src/libre/dialect/native/parser.c"
		}
...
#line 2394 "src/libre/dialect/native/parser.c"
