...
#line 211 "src/libre/dialect/literal/parser.c"
...
#line 259 "src/libre/dialect/literal/parser.c"
		}
...
void
p_re__literal(flags flags, lex_state lex_state, act_state act_state, err err, t_ast__expr *ZOnode)
{
	t_ast__expr ZInode;
...
static void
p_list_Hof_Hatoms_C_Catom(flags flags, lex_state lex_state, act_state act_state, err err, t_ast__expr *ZOnode)
{
	t_ast__expr ZInode;
...
#line 406 "src/libre/dialect/literal/parser.c"
			}
			/* END OF EXTRACT: CHAR */
			break;
		default:
...
#line 441 "src/libre/dialect/literal/parser.c"
		}
...
#line 455 "src/libre/dialect/literal/parser.c"
		}
		/* END OF ACTION: ast-make-empty */
	}
	goto ZL0;
...
#line 618 "src/libre/dialect/literal/parser.c"
